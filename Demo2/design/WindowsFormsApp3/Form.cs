...
namespace WindowsFormsApp1
{
    public partial class createaccount : Form
    {
        ...
        private void signup_Click(object sender, EventArgs e)
        {
            ...
            {
                if (string.IsNullOrEmpty(text_user.Text) || string.IsNullOrEmpty(text_email.Text) || string.IsNullOrEmpty(text_pass.Text) || string.IsNullOrEmpty(text_enterpass.Text) || string.IsNullOrEmpty(txt_birth.Text))
                {
                ...
                else
                {
                    ...
                    con.Open();
                    SqlCommand cmd = new SqlCommand("insert into UserTable values (@User,@Email,@Birth,@Password )", con);
